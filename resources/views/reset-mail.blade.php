                            ...
                            <tr>
                                <td align="center">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                <td align="center" style="font-family: 'Roboto', sans-serif; font-size:22px; font-weight: bold;
                                                color:#000;line-height: 18px;">Password Reset Link<br> </td>
                                            </tr>
                                            <tr>
                                                <td height="20"></td>
                                            </tr>
                                            <tr>
                                               <td align="center" style="font-size:13px;color: #000;line-height: 18px;font-family: 'Roboto', sans-serif;">
                                                ...
                                                <td align="center">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr >
                                                                <td >
                                                                    <a href="{{ Route('reset_password',[$user])}}" style="color: #fff;text-decoration: none;background: #433185;width: 110px;height: 30px;display: inline-block;font-size: 15px;text-align: center;line-height: 30px;font-family: 'Roboto', sans-serif; display: table-cell;    vertical-align: middle;  ">
                                                                        Reset link <span style="padding-left: 4px;"><img src="https://www.appgurus.com.au/wp-content/uploads/2021/10/arrow-right.png" style="height: 10px; width: 10px;"  alt=""></span></a>
                                                                </td>
                                                                <td width="15"></td>
                                                                {{-- <td>
