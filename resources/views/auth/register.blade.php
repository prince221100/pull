            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Emp Id') }}</label>

                            <div class="col-md-6">
                                <input id="email" type="name" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id" value="{{ old('employee_id') }}" required autocomplete="email">
